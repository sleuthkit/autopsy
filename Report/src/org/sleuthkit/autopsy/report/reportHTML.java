...
public reportHTML (HashMap<BlackboardArtifact,ArrayList<BlackboardAttribute>> report){
        ...
        try{
            ...
            formatted_Report.append("<html><head>Autopsy Report for Case:");
            formatted_Report.append(caseName);
            formatted_Report.append("</head><body><div id=\"main\"><div id=\"content\">");
            // Add summary information now
            formatted_Report.append("<h1>Report for Case: " + caseName + "</h1>");
            formatted_Report.append("<h3>Case Summary</h3><p>XML Report Generated by Autopsy 3 on " + datetime + "<br /><ul>");
            formatted_Report.append("<li># of Images: " + imagecount + "</li>");
            formatted_Report.append("<li>FileSystems: " + filesystemcount + "</li>");
             ...
             for (Entry<BlackboardArtifact,ArrayList<BlackboardAttribute>> entry : report.entrySet()) {
                ...
                artifact.append("<br /> Name: <strong>" + file.getName().toString() + "</strong>");
                artifact.append("<br />Path: " + file.getParentPath());
                ...
                artifact.append("</p><ul style=\"list-style-type: none;\">");
                    ...
                    // Get all the attributes for this guy
                     for (BlackboardAttribute tempatt : entry.getValue())
                         {
                          StringBuilder attribute = new StringBuilder("<li style=\"list-style-type: none;\">Type:  " + tempatt.getAttributeTypeDisplayName() + "</li>");
                          attribute.append("<li style=\"list-style-type: none;\">Value:  " + tempatt.getValueString() + "</li>");
                          attribute.append("<li style=\"list-style-type: none;\"> Context:  " + tempatt.getContext() + "</li>");
