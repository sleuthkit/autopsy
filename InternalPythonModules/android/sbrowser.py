...
class SBrowserAnalyzer(general.AndroidComponentAnalyzer):
    ...
    def analyzeBookmarks(self, dataSource, fileManager, context):
            sbrowserDbs = AppSQLiteDB.findAppDatabases(dataSource, "sbrowser.db", "com.sec.android.app.sbrowser")
    ...
    def analyzeCookies(self, dataSource, fileManager, context):
            cookiesDbs = AppSQLiteDB.findAppDatabases(dataSource, "Cookies", "com.sec.android.app.sbrowser")
    ...
    def analyzeHistory(self, dataSource, fileManager, context):
            historyDbs = AppSQLiteDB.findAppDatabases(dataSource, "History", "com.sec.android.app.sbrowser")
    ...
    def analyzeDownloads(self, dataSource, fileManager, context):
            downloadsDbs = AppSQLiteDB.findAppDatabases(dataSource, "History", "com.sec.android.app.sbrowser")
    ...
    def analyzeAutofill(self, dataSource, fileManager, context):
            autofillDbs = AppSQLiteDB.findAppDatabases(dataSource, "Web Data", "com.sec.android.app.sbrowser")
    ...
    def analyzeWebFormAddress(self, dataSource, fileManager, context):
            webFormAddressDbs = AppSQLiteDB.findAppDatabases(dataSource, "Web Data", "com.sec.android.app.sbrowser")
