 ...
 */
public class HashDbSearchNode extends AbstractNode implements DisplayableItemNode {
    
    SearchFilters.SearchFilterInterface filter;
    SleuthkitCase skCase;

    HashDbSearchNode(SearchFilters.SearchFilterInterface filter, SleuthkitCase skCase) {
