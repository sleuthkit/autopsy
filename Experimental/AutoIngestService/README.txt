...
10) If your administrator account does not have the "Log on as a service"
    right, it will need to be added. To do this, open the Local Security
	Policy tool, expand "Local Policies", and click "User Rights Assignment".
	Double-click the "Log on as a service" policy and add the administrator
	account to the list in the Local Security Setting tab.

11) Now the service is ready. You can start it by either restarting Windows
