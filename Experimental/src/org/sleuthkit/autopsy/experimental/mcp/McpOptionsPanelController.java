...
public final class McpOptionsPanelController extends OptionsPanelController {
    ...
    private static final Logger logger = Logger.getLogger(McpOptionsPanelController.class.getName());
    ...
    private McpOptionsPanel getPanel() {
        if (panel == null) {
            panel = new McpOptionsPanel(this);
        }
        return panel;
    }
    ...
    void changed() {
        if (!changed) {
            ...
            try {
                ...
                logger.log(Level.SEVERE, "McpOptionsPanelController listener threw exception", ex); //NON-NLS
