...
final class ExtractPrefetch extends Extract {
    ...
    private static final String PREFETCH_TOOL_NAME_MACOS = "parse_prefetch_macos.exe"; //NON-NLS
    private static final String PREFETCH_TOOL_NAME_LINUX = "parse_prefetch_linux.exe"; //NON-NLS
