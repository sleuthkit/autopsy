...
class StringsTextExtractor implements TextExtractor {
    ...
    private static class AbstractFileStringStream extends InputStream {
         ...
         *
         */
        private AbstractFileStringStream(AbstractFile content, Charset outputCharset) {
    ...
    private static class AbstractFileStringIntStream extends InputStream {
         ...
         */
        public AbstractFileStringIntStream(AbstractFile content, List<SCRIPT> scripts, boolean extractUTF8, boolean extractUTF16, Charset outCharset) {
            this.content = content;
