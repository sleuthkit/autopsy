...
public class AnalysisResultDAO extends BlackboardArtifactDAO {
    ...
    public DataArtifactTableSearchResultsDTO getAnalysisResultsForTable(AnalysisResultSearchParam artifactKey) throws ExecutionException, IllegalArgumentException {
