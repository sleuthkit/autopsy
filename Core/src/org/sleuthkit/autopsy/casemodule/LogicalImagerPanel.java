...
public class LogicalImagerPanel extends JPanel implements DocumentListener {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(pathLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.pathLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(timeZoneLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.timeZoneLabel.text")); // NOI18N

        timeZoneComboBox.setMaximumRowCount(30);

        org.openide.awt.Mnemonics.setLocalizedText(noFatOrphansCheckbox, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.noFatOrphansCheckbox.text")); // NOI18N
        noFatOrphansCheckbox.setToolTipText(org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.noFatOrphansCheckbox.toolTipText")); // NOI18N

        errorLabel.setForeground(new java.awt.Color(255, 0, 0));
        org.openide.awt.Mnemonics.setLocalizedText(errorLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.errorLabel.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(sectorSizeLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.sectorSizeLabel.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(sha256HashLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.sha256HashLabel.text")); // NOI18N
        sha256HashLabel.setEnabled(false);

        sha256HashTextField.setText(org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.sha256HashTextField.text")); // NOI18N
        sha256HashTextField.setEnabled(false);

        sha1HashTextField.setText(org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.sha1HashTextField.text")); // NOI18N
        sha1HashTextField.setEnabled(false);

        md5HashTextField.setText(org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.md5HashTextField.text")); // NOI18N
        md5HashTextField.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(sha1HashLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.sha1HashLabel.text")); // NOI18N
        sha1HashLabel.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(md5HashLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.md5HashLabel.text")); // NOI18N
        md5HashLabel.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(hashValuesLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.hashValuesLabel.text")); // NOI18N
        hashValuesLabel.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(hashValuesNoteLabel, org.openide.util.NbBundle.getMessage(LogicalImagerPanel.class, "LogicalImagerPanel.hashValuesNoteLabel.text")); // NOI18N
    ...
    @NbBundle.Messages({"LogicalImagerPanel.000.confirmationMessage=The selected file"
            ...
            if (path.endsWith(".001")) {
                ...
                if (new File(zeroX3_path).exists()) {
                    int showConfirmDialog = JOptionPane.showConfirmDialog(this,
                            Bundle.LogicalImagerPanel_000_confirmationMessage(),
     ...
     */
    @NbBundle.Messages({
        "LogicalImagerPanel.validatePanel.dataSourceOnCDriveError=Warning: Path to multi-user data source is on \"C:\" drive",
        "LogicalImagerPanel.validatePanel.invalidMD5=Invalid MD5 hash",
        "LogicalImagerPanel.validatePanel.invalidSHA1=Invalid SHA1 hash",
        "LogicalImagerPanel.validatePanel.invalidSHA256=Invalid SHA256 hash",})
    public boolean validatePanel() {
        ...
        if (!StringUtils.isBlank(getMd5()) && !HashUtility.isValidMd5Hash(getMd5())) {
            ...
            errorLabel.setText(Bundle.LogicalImagerPanel_validatePanel_invalidMD5());
            return false;
        }

        if (!StringUtils.isBlank(getSha1()) && !HashUtility.isValidSha1Hash(getSha1())) {
            errorLabel.setVisible(true);
            errorLabel.setText(Bundle.LogicalImagerPanel_validatePanel_invalidSHA1());
            return false;
        }

        if (!StringUtils.isBlank(getSha256()) && !HashUtility.isValidSha256Hash(getSha256())) {
            errorLabel.setVisible(true);
            errorLabel.setText(Bundle.LogicalImagerPanel_validatePanel_invalidSHA256());
            return false;
        }

        if (!PathValidator.isValidForMultiUserCase(path, Case.getCurrentCase().getCaseType())) {
            errorLabel.setVisible(true);
            errorLabel.setText(Bundle.LogicalImagerPanel_validatePanel_dataSourceOnCDriveError());
        }
