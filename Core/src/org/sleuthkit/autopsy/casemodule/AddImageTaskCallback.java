...
class AddImageTaskCallback {
    ...
    AddImageTaskCallback(IngestStream dsp, DataSourceProcessorCallback dspCallback) {
        this.ingestStream = dsp;
    ...
    void onCompleted(DataSourceProcessorResult result, List<String> errList, List<Content> newDataSources) {
        System.out.println("In AddImageTaskCallback wtih result: " + result.toString());
        // TODO call done
    }
}
