...
public final class IngestJobSettingsPanel extends javax.swing.JPanel {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (!listSelectionModel.isSelectionEmpty()) {
                    ...
                    if (null != selectedModule.getModuleSettingsPanel()) {
                        ...
                        ingestSettingsPanel.add(new JLabel("No per ingest settings for this module."));
                    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(575, 340));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(descriptionLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
    ...
    static private class IngestModuleModel {
        ...
        String getDescription() {
            return "<html>" + moduleTemplate.getModuleDescription() + "</html>";
        }
