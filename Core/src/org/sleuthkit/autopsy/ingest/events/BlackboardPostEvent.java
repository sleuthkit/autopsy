...
public final class BlackboardPostEvent extends AutopsyEvent implements Serializable {
    ...
    public BlackboardPostEvent(AutopsyEvent.SourceType sourceType, ModuleDataEvent eventData) {
         ...
         * of BlackboardArtifact objects for remote events.
         */
        super(
                sourceType,
    ...
    public Object getOldValue() {
         ...
         * of the ModuleDataEvent object bypasses the issues related to the
         * serialization and de-serialization of BlackboardArtifact objects for
