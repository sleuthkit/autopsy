...
/**
 * An interface that must be implemented by all providers of ingest modules.
 * An IngestModuleFactory will be used as a stateless source of one or more 
...
public interface IngestModuleFactory {
     ...
     * execution contexts. 
     * @return The ingest options in serializable form.
     */
    Serializable getDefaultIngestOptions();
     ...
     */
    JPanel getIngestOptionsPanel(Serializable ingestOptions);
     ...
     * @return The ingest options from the panel in serializable form.
     * @throws org.sleuthkit.autopsy.ingest.IngestModuleFactory.InvalidOptionsException 
     */
    Serializable getIngestOptionsFromPanel(JPanel ingestOptionsPanel) throws InvalidOptionsException;
    ...
    /**
     * Get the global options for instances of the family of ingest modules 
     * the factory creates from a global options panel and saves the options to 
     ...
     * @param ingestOptions The ingest options to use to create the module.
     * @return An instance of a data source ingest module created using the
     * provided ingest options.
     */
    DataSourceIngestModule createDataSourceIngestModule(Serializable ingestOptions) throws InvalidOptionsException;
     ...
     * provided ingest options.
     */
    FileIngestModule createFileIngestModule(Serializable ingestOptions) throws InvalidOptionsException;
}
