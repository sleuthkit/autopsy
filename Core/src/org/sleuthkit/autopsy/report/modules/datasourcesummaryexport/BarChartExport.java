...
public class BarChartExport implements ExcelItemExportable, ExcelSheetExport {
     ...
     */
    private static ExcelTableExport<Pair<Object, List<Double>>, ? extends DefaultCellModel> getTableModel(
    ...
    private final ExcelTableExport<Pair<Object, List<Double>>, ? extends DefaultCellModel> tableExport;
