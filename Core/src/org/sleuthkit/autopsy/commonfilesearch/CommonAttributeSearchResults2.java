 ...
 */
final public class CommonAttributeSearchResults2 {

    private static final Logger LOGGER = Logger.getLogger(CommonAttributeSearchResults2.class.getName());
     ...
     *                            searches
     */
    CommonAttributeSearchResults2(Map<String, Map<String, CommonAttributeValueList>> metadata, int percentageThreshold, CorrelationAttributeInstance.Type resultType, Set<String> mimeTypesToFilterOn) {
     ...
     *                            common, value of 0 is disabled
     */
    CommonAttributeSearchResults2(Map<String, Map<String, CommonAttributeValueList>> metadata, int percentageThreshold) {
        //wrap in a new object in case any client code has used an unmodifiable collection
        this.caseNameToDataSources = new HashMap<>(metadata);
        this.percentageThreshold = percentageThreshold;
...
//        }  //WJS-TODO re-do and enable filtering
//        else {
...
//
//        Map<String, List<CommonAttributeValue>> itemsToRemove = new HashMap<>();
...
//
//            final String caseNameKey = mapOfDataSources.getKey();
...
//                final String dataSourceNameKey = listOfValues.getKey();
...
//                                    if (itemsToRemove.containsKey(caseNameKey)) {
//                                        itemsToRemove.get(caseNameKey).add(value);
//                                    } else {
//                                        List<CommonAttributeValue> toRemove = new ArrayList<>();
//                                        toRemove.add(value);
//                                        itemsToRemove.put(caseNameKey, toRemove);
//                                    }
...
//        }
//
//        for (Entry<String, List<CommonAttributeValue>> valuesToRemove : itemsToRemove.entrySet()) {
//            final String key = valuesToRemove.getKey();
//            final List<CommonAttributeValue> values = valuesToRemove.getValue();
//            for (CommonAttributeValue value : values) {
//                final CommonAttributeValueList instanceCountValue = this.caseNameToDataSources.get(key);
...
//                        this.caseNameToDataSources.remove(key);
//                    }
//                }
//            }
//        }
...
//
//        int count = 0;
//        for (CommonAttributeValueList data : this.caseNameToDataSources.values()) {
