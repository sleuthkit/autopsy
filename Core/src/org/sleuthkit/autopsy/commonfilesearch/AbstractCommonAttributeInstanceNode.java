...
abstract class AbstractCommonAttributeInstanceNode {
     ...
     * necessary.  This will be called by this.lookupOrLoadAbstractFile.  In 
    ...
    /**
     * Get the map of AbstractFile which we use to avoid loading the same
     * file from the SleuthkitCase more than necessary.
     * 
