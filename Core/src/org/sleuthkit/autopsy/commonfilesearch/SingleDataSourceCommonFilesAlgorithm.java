 ...
 */
final public class SingleDataSourceCommonFilesAlgorithm extends IntraCaseCommonFilesMetadataBuilder {
     ...
     */
    public SingleDataSourceCommonFilesAlgorithm(Long dataSourceId, Map<Long, String> dataSourceIdMap, boolean filterByMediaMimeType, boolean filterByDocMimeType) {
    ...
    protected String buildSqlSelectStatement() {
        ...
        return String.format(SingleDataSourceCommonFilesAlgorithm.WHERE_CLAUSE, args);
    }
