 ...
 */
public class CentralRepoCommonAttributeInstanceNode2 extends DisplayableItemNode {

    private final CorrelationAttributeInstance crFile;
    
    CentralRepoCommonAttributeInstanceNode2(CorrelationAttributeInstance content) {
