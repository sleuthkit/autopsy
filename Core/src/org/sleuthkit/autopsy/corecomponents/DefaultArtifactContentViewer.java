...
public class DefaultArtifactContentViewer extends javax.swing.JPanel implements ArtifactContentViewer {
    ...
    @NbBundle.Messages({
        ...
        "DefaultArtifactContentViewer.failedToGetSourcePath.message=Failed to get source file path from case database",
        "DefaultArtifactContentViewer.failedToGetAttributes.message=Failed to get some or all attributes from case database"
    })
    private final static Logger logger = Logger.getLogger(DefaultArtifactContentViewer.class.getName());
    private final static String WAIT_TEXT = NbBundle.getMessage(DefaultArtifactContentViewer.class, "DefaultArtifactContentViewer.waitText");
    private final static String ERROR_TEXT = NbBundle.getMessage(DefaultArtifactContentViewer.class, "DefaultArtifactContentViewer.errorText");
        ...
        private void addRows(BlackboardArtifact artifact) {
            ...
            try {
                ...
                try {
                    ...
                    path = Bundle.DefaultArtifactContentViewer_failedToGetSourcePath_message();
                }
                ...
                rowsToAdd.add(new String[]{"", Bundle.DefaultArtifactContentViewer_failedToGetAttributes_message(), ""});
            }
