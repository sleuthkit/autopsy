...
import org.sleuthkit.autopsy.contentutils.ContainerSummary.ContainerDetails;
import org.sleuthkit.autopsy.contentutils.ContainerSummary.ImageDetails;
...
class ContainerPanel extends BaseDataSourceSummaryPanel {
    ...
    protected List<ExcelSheetExport> getExports(DataSource ds) {
        ContainerDetails result = getFetchResult(containerDataFetcher, "Container sheets", ds);
        ...
        ImageDetails imageModel = result.getImageDetails();
        ...
        List<String> paths = result.getImageDetails() == null ? Collections.singletonList(NA) : result.getImageDetails().getPaths();
