...
import org.sleuthkit.autopsy.modules.imageExtractionParsing.ImageExtractorParserFileIngestModule.SupportedExtractionFormats;
...
public class ImageExtractor {
    ...
    ImageExtractor(IngestJobContext context) {
        ...
        this.moduleDirRelative = Case.getModulesOutputDirRelPath() + File.separator + ImageExtractorParserModuleFactory.getModuleName();
        this.moduleDirAbsolute = currentCase.getModulesOutputDirAbsPath() + File.separator + ImageExtractorParserModuleFactory.getModuleName();
        ...
        if (!extractionDirectory.exists()) {
            try {
                ...
                services.postMessage(IngestMessage.createErrorMessage(ImageExtractorParserModuleFactory.getModuleName(), "Error initializing", "Error initializing output dir: " + moduleDirAbsolute)); //NON-NLS
     ...
     */
    protected void extractImage(SupportedExtractionFormats format, AbstractFile abstractFile){
        // 
        ...
        for (ExtractedImage extractedImage : listOfExtractedImages) {
            try {
                listOfExtractedImageAbstractFiles.add(fileManager.addDerivedFile(extractedImage.getFileName(), extractedImage.getLocalPath(), extractedImage.getSize(),
                        ...
                        true, abstractFile, null, ImageExtractorParserModuleFactory.getModuleName(), null, null));
