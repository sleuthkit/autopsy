...
import org.sleuthkit.autopsy.timeline.ui.filtering.datamodel.TimelineFilterState;
        ...
        final LoggedTask<Collection<Long>> selectTimeAndTypeTask = new LoggedTask<Collection<Long>>("Select Time and Type", true) { //NON-NLS
            ...
            protected Collection< Long> call() throws Exception {
                synchronized (TimeLineController.this) {
                    return filteredEvents.getEventIDs(timeRange, new TimelineFilterState<>(new EventTypeFilter(type), true));
                }
            }
