...
final public class EventStripeNode extends StackPane {
    ...
    public EventStripeNode(EventDetailsChart chart, EventStripe eventStripe, EventStripeNode parentEventNode) {
        ...
        EventDetailsChart.HideDescriptionAction hideClusterAction = chart.new HideDescriptionAction(getDescription(), eventStripe.getDescriptionLoD());
