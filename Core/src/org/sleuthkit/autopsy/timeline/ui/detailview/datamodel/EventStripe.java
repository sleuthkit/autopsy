...
public final class EventStripe implements MultiEvent<EventCluster> {
    ...
    public static EventStripe merge(EventStripe u, EventStripe v) { //NOPMD
        ...
        Preconditions.checkArgument(Objects.equals(u.types, v.types));
    ...
    public EventStripe withParent(EventCluster parent) {
        ...
        return new EventStripe(parent, this.types, this.description, this.lod, clusters, eventIDs, tagged, hashHits);
    }

    private EventStripe(EventCluster parent, Collection<EventType> types, String description, DescriptionLoD lod, SortedSet<EventCluster> clusters, ImmutableSet<Long> eventIDs, ImmutableSet<Long> tagged, ImmutableSet<Long> hashHits) {
        this.parent = parent;
    ...
    public EventStripe(EventCluster cluster) {
        ...
        types = ImmutableSet.copyOf(cluster.getEventTypes());
    ...
    private EventStripe(EventStripe u, EventStripe v) { //NOPMD
        ...
        types = ImmutableSet.<EventType>builder()
                .addAll(u.getEventTypes())
                .addAll(v.getEventTypes())
                .build();
