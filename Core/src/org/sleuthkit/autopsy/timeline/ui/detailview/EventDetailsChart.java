...
public final class EventDetailsChart extends XYChart<DateTime, EventCluster> implements TimeLineChart<DateTime> {
    ...
    private final InvalidationListener layoutInvalidationListener = (Observable o) -> {
        synchronized (EventDetailsChart.this) {
            requiresLayout = true;
            requestChartLayout();
        }
    };
    ...
    EventDetailsChart(TimeLineController controller, DateAxis dateAxis, final Axis<EventCluster> verticalAxis, ObservableList<EventStripeNode> selectedNodes) {
