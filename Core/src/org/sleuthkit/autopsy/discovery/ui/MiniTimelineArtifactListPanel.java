...
class MiniTimelineArtifactListPanel extends JPanel {
    ...
    private class TypeDescriptionTableModel extends AbstractTableModel {
        ...
        private String getDescription(BlackboardArtifact artifact) {
            try {
                return artifact.getAttribute(new Type(BlackboardAttribute.ATTRIBUTE_TYPE.TSK_DESCRIPTION)).getDisplayString();
        ...
        @ThreadConfined(type = ThreadConfined.ThreadType.AWT)
        @NbBundle.Messages({
            "MiniTimelineArtifactListPanel.typeColumn.name=Date",
            "MiniTimelineArtifactListPanel.descriptionColumn.name=Count"})
        @Override
