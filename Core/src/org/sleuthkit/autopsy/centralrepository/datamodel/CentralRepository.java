...
public interface CentralRepository {
     ...
     * value.
     *
     * @param aType        Correlation attribute type to search for.
     * @param value        Value to search for.
     * @param fileObjectId The file_obj_id for the instance to ignore.
     * @param caseId       The id for the case in the central repository.
     *
