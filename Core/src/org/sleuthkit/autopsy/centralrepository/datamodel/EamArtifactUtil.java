...
public class EamArtifactUtil {
    ...
    static {
        CORRELATABLE_ATTRIBUTES = ImmutableMap.<Integer, Integer>builder()
                ...
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_TEXT.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_FAX.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_MOBILE.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_VIDEO.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_PAGER.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_TEXTPHONE.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_VOICE_MESSAGING.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_BBS.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_MODEM.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_CAR.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_ISDN.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                .put(ATTRIBUTE_TYPE.TSK_PHONE_NUMBER_PCS.getTypeID(), CorrelationAttributeInstance.PHONE_TYPE_ID)
                ...
                .put(ATTRIBUTE_TYPE.TSK_EMAIL_X400.getTypeID(), CorrelationAttributeInstance.EMAIL_TYPE_ID)
