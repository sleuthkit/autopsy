...
#  Usage: ./regression.py [-i FILE] OR [-l CONFIG]  [OPTIONS]
...
#    -u, --ignore       Ignores unallocated space when ingesting. Faster, but less accurate results.
...
def main():
  ...
  test = True
  argi = 1
  Config = None   #file pointed to by -l
  imgListB = []   #list of legal images from imgListA generated by main()
  cwd = wgetcwd()
  ...
  if list:
    ...
    errors = 0
    global inDir
    out = Config.getElementsByTagName("indir")[0].getAttribute("value").encode()
